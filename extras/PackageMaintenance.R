...
OhdsiRTools::checkUsagePackage("EnsemblePatientLevelPrediction")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual and vignettes
unlink("extras/EnsemblePatientLevelPrediction.pdf")
system("R CMD Rd2pdf ./ --output=extras/EnsemblePatientLevelPrediction.pdf")
